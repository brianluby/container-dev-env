...
- Bash 5.x (bootstrap script), Markdown (content files) + None (static files + POSIX-compatible shell script) (010-project-context-files)
- Filesystem (static files committed to git repository) (010-project-context-files)
