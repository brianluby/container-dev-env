# Volume Architecture for Development Containers

## Overview

This document describes the hybrid volume architecture used by the development container environment. The architecture balances three competing concerns:
